...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul class="flex flex-col p-4 mt-4 bg-gray-200 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-gray-300">
      <li>
        <a href="/" class="block text-xl font-extrabold py-2 pr-4 pl-3 text-gray-700 bg-blue-700 md:hover:text-blue-700 rounded md:bg-transparent md:p-0" aria-current="page">Volver</a>
      </li>
    </ul>
  </div>
  </div>
...
<div id="formulario" class="mt-40 w-[90%] m-auto">
          <form action="{{route('registros.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <button type="submit" class="mt-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full text-center sm:w-auto px-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Registarse</button>
          </form>
